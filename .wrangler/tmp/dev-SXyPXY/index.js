(() => {
  ...
  // .wrangler/tmp/bundle-UG4tRf/checked-fetch.js
...
`
  ...
  // .wrangler/tmp/bundle-UG4tRf/middleware-insertion-facade.js
  ...
  async function handleEvent(event) {
    try {
      return await (0, import_kv_asset_handler.getAssetFromKV)(event, { mapRequestToAsset: import_kv_asset_handler.serveSinglePageApp });
    } catch (error) {
